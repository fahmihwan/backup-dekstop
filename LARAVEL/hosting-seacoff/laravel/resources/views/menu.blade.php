...
@section('container')
                                ...
                                <div class="menuItems card-body">
                                    ...
                                    <div class="d-flex bd-highlight ">
                                        <div class="bd-highlight ">
                                            <p class=" card-text pt-3 text-danger fw-bold" style="font-size: 12px">
                                                Rp. <span class="priceElementItems"> {{ $menu->harga }} </span>
                                            </p>
                                        </div>
                                        <div class="ms-auto pt-2 bd-highlight js-order-group">
                                            ...
                                            <div class="js-btn-group-input input-group input-group-sm input-group-md"
                                                ...
                                                <input type="number" class="js-input-spinner-number form-control"
    ...
    <section id="sec-kategori-ice" class="p-0 ">
        <h3 class="mt-2" class="text-muted"> Ice</h3>
        <div class="d-flex flex-wrap ">
            @foreach ($menus as $menu)
    ...
    <section id="sec-kategori-sncak" class="p-0 ">
        <h3 class="mt-2" class="text-muted">Snack</h3>
        <div class="d-flex flex-wrap ">
            @foreach ($menus as $menu)
    ...
    <section id="sec-kategori-food" class="p-0 ">
        <h3 class="mt-2" class="text-muted">Food</h3>
        <div class="d-flex flex-wrap ">
            @foreach ($menus as $menu)
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function(event) {
            ...
            function totalOrder(e, operator) {
                ...
                // console.log(target)
                let currentPrice = parseInt(getPrice.innerText);
                ...
                for (let i = 0; i <= listMenu.length - 1; i++) {
                    if (jumlah[i].value > 0) {
                        getDataTransaksi.push({
                            ...
                            gambar: gambar[i].src,
                            jumlah: parseInt(jumlah[i].value),
                            harga: parseInt(harga[i].innerText),
                        })
                    }
                }
