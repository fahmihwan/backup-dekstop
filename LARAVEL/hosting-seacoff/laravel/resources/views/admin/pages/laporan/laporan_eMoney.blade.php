...
@section('container')
    ...
    <div class="row">
        <div class="col-md-12">
            <div style=" background-color: white; padding: 15px; width:auto;  overflow: scroll;">
                <table id="example" class="table table-hover display border " style="width: 150%">
                    <thead>
                        <tr>
                            <th>no</th>
                            <th>nota</th>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return "<a href='/admin/laporan/detail-pemesanan/" + row.nota + "'>" +
                                row.nota + "</a>"
                        }
                    },
                    {
