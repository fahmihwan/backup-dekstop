...
@section('container')
                        ...
                        <div class="card-body p-2">
                            <div class="d-flex bd-highlight  ">
                                ...
                                <div class="bd-highlight text-end ">
                                    ...
                                    <p
                                        class="menu-status p-0 m-0 {{ $menu->status !== 'habis' ? 'text-success' : 'text-warning' }}">
                                        {{ $menu->status }}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-4 cart-menu card">
            ...
            <div class="d-flex align-items-end mb-4 " style="height:55px">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                    style="width: 100%" id="modal-bayar">
                    Bayar
                </button>
                    ...
                    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-muted">
                                            <input type="text" class="form-control" value="" id="modal-nama">
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-muted">
                                            <select name="" id="modal-meja" class="form-control">
                                                <option value="0">belum dapat meja</option>
                                                @foreach ($kategori_meja as $meja)
                        ...
                        <div class="col-md-7">
                            ...
                            <table class="tb-modal-kembalian">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <Button class="btn-sm btn-success btn-tunai me-2"
                                            data-uang-tunai="10000">Rp.10000</Button>
                                        <Button class="btn-sm btn-success btn-tunai me-2"
                                            data-uang-tunai="20000">Rp.20000</Button>
                                        <Button class="btn-sm btn-success btn-tunai me-2"
                                            data-uang-tunai="50000">Rp.50000</Button>
                                        <Button class="btn-sm btn-success btn-tunai me-2"
                                            data-uang-tunai="100000">Rp.100000</Button>
                                    </td>
                                </tr>
                                <tr>
    ...
    <form method="POST" action="/admin/penjualan/store" id="form-submit" hidden>
        ...
        <input type="text" name="meja" value="">
    ...
    <script>
        ...
        payNow.addEventListener('click', function() {
            if (_dataKembalian.uangTunai != null && _dataKembalian.kembalian != null) {
                document.querySelector('[name=meja]').value = document.getElementById('modal-meja').value;
                document.querySelector('[name=nama]').value = document.getElementById('modal-nama').value;
