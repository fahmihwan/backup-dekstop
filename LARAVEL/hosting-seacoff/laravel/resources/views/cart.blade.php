    ...
    <div class="row mt-2">
        <div class="col-md-12 py-2" style="background-color: white">
            ...
            <div class="d-flex bd-highlight pb-1">
                ...
                <div class=" bd-highlight"><b id="total-price">0</b></div>
            </div>
            <div class="d-grid gap-2 mb-3">
                <form action="/menu/payment/" method="POST" id="send_json">
                    @csrf
                    <input type="text" value="" name="json_name" id="json_order_name" hidden>
                    <input type="text" value="" name="json_email" id="json_order_email" hidden>
                    <input type="text" value="" name="json_menu" id="json_callback" hidden>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function(event) {
                                ...
                                <div class="menuItems card-body">
                                    ...
                                    <div class="d-flex bd-highlight ">
                                        <div class="bd-highlight ">
                                            <p class="card-text pt-3 text-danger fw-bold"
                                                style="font-size: 12px">
                                               Rp <span class="priceElementItems">${orderList[i].harga}</span>
                                            </p>
                                        </div>
            ...
            function changePriceElement(dataJson, eHargaSatuan, jumlah) {
                const price = parseInt(dataJson.harga);

                let total = price * jumlah.value;
                eHargaSatuan.innerText = total;
            ...
            function summaryOrders() {
                ...
                for (let i = 0; i <= priceElements.length - 1; i++) {
                    ...
                    realPrice += parseInt(priceElements[i].innerText);
                    let harga = parseInt(orderList[i].harga)
                    dataJson.push({
                        id: orderList[i].id,
            ...
            const orderEmail = document.getElementById('json_order_email');
                ...
                Swal.fire({
                    ...
                    preConfirm: (login) => {
                        ...
                        Swal.fire({
                            ...
                            inputLabel: 'Masukan email anda untuk menerima nota',
