...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('/admin/laporan')->group(function () {
        Route::get('/detail-pemesanan/{nota}', [DashboardLaporanController::class, 'detail_pemesanan']);
        Route::get('/penjualan', [DashboardLaporanController::class, 'laporan']);
        Route::get('/e-money', [DashboardLaporanController::class, 'laporan_eMoney']);
        Route::get('/cash', [DashboardLaporanController::class, 'laporan_cash']);
        Route::get('/grafik-penjualan', [DashboardLaporanController::class, 'grafik_penjualan']);
        Route::get('/{year}/grafik-penjualan', [DashboardLaporanController::class, 'list_grafik_penjualan']);
    });
    ...
    //admin-PDF
    Route::prefix('/admin/laporan/penjualan/print')->group(function () {

        Route::post('/nota-customer', [PdfController::class, 'export_nota_customer']);

        Route::post('/laporan_date', [PdfController::class, 'laporan_date']);
        Route::post('/laporan_month', [PdfController::class, 'laporan_month']);

        Route::post('/laporan_eMoney_date', [PdfController::class, 'laporan_eMoney_date']);
        Route::post('/laporan_eMoney_month', [PdfController::class, 'laporan_eMoney_month']);

        Route::post('/laporan_cash_date', [PdfController::class, 'laporan_cash_date']);
        Route::post('/laporan_cash_month', [PdfController::class, 'laporan_cash_month']);
    });
